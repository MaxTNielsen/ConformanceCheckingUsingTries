...
def run(model_fp: str, data_fp: str, conf_out: str, model_name, log_name):
        ...
        for fold_id in range(k):
            ...
            # logstartprob_fp_i = logstartprob_fp.format(log_name, model_name, fold_id)
            # logtranscube_fp_i = logtranscube_fp.format(log_name, model_name, fold_id)
            # logtranscube_d_fp_i = logtranscube_d_fp.format(log_name, model_name, fold_id)
            # logemitmat_fp_i = logemitmat_fp.format(log_name, model_name, fold_id)
            # logemitmat_d_fp_i = logemitmat_d_fp.format(log_name, model_name, fold_id)
            # confmat_fp_i = confmat_fp.format(log_name, model_name, fold_id)
            ...
            test_hmmconf_feature_df.to_csv(conf_out.replace('.csv', "_{}.csv".format(fold_id)), index=None)
